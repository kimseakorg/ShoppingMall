  ...
  var loadMyCartEvent = function(userOptions){
    ...
    if(!$("#" + idCartModal).length) {
      $('body').append(
        ...
        '<h4 class="modal-title" id="myModalLabel"><span class="fa fa-gratipay"></span> My Favorites</h4>' +
        '</div>' +
    ...
    var drawTable = function(){
      ...
      $.each(products, function(){
        ...
        $cartTable.append(
          ...
          '<td ><a href="#" style="color:green">' + this.name + '</a></td>' +
...
//        '<td></td>' +
//        '</tr>'
//        : '<div class="alert alert-danger" role="alert" id="' + idEmptyCartMessage + '">Your Favorite is empty</div>'
//      );
